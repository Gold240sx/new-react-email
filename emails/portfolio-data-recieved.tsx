...
export const DataRecieved = () => (
	<Tailwind
		...
		<Html>
			<Head />
			<Preview>Michael-Martell.com - You're email has been recieved!</Preview>
				...
				<Container className="pt-5 pb-12 mx-auto my-0 mb-16 bg-white">
					<Section className="px-12 py-0">
						<div className="flex flex-row justify-center align-middle">
							<div className="w-fit">
								<Img src={`${baseUrl}/static/assets/mac.png`} width="55" height="55" alt="icon" />
							</div>
							<div className="flex justify-center w-4/5 align-middle">
								<Text className="text-2xl tracking-wide text-gray-400">MICHAEL-MARTELL.com</Text>
							</div>
						</div>
						<Hr style={hr} />
						...
						<Text style={paragraph} className="text-zinc-400">
							Thank you for reaching out! I treat every email as a priority and am excited to begin chatting. I will get back
							to you as soon as I can!
						</Text>
						<Text style={paragraph} className="text-zinc-400">
							Please save my email: <span className="text-sky-600">240designworks@gmail.com</span> to prevent any missed
							communication, and if applicable, mark as important.
						</Text>
						<Text style={paragraph} className="text-zinc-400">
							Feel free to check out my website and social media accounts below. I am always posting new content.
						</Text>
						<Text style={paragraph} className="text-zinc-400">
							— Michael Martell
						</Text>
						...
						<Hr style={hr} />
						<Text className="text-xl font-semibold text-[#8898aa]">Your Form Submission:</Text>
